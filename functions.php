...
// Similar to business push, updates or adds user based userID being zero or greater
	...
	function dashboard($userID, $userFullName) {
        ...
        print "<form method=GET action='http://homepages.uc.edu/group1/business.php?CreateBusiness=True'><input type='submit' value='Add New Business'  class='myButton'/></form><br />";
